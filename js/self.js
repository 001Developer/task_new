...

							{
								...
								setTimeout(function(){
									...
									// 	sessionStorage.removeItem('redirect');
										...
										window.location.href = myurl+"dashboard.php";
...

	{
		...
		src : myurl+'images/loading.gif'
			...
			setTimeout(function(){
				...
				window.location.href = myurl+"index.php/Farmer_Register/";
		...
		src : myurl+'images/sprites.gif'
			...
			setTimeout(function(){
				...
				window.location.href = myurl+"index.php/workholder/";
...

				{
...

					{
...

						{
							...
							$.post(myurl+"fetch/venderregister.php", {"name":name,"tel":tel,"cntry":cntry,"city":city,"address":address,"email":email,"captcha":captcha},
									...
									setTimeout(function(){
	                                 ...
	                                 if(cntry=="")

	                                       {
			                                 ...
			                                 $("#msg").html('<div class="alert alert-warning" role="alert"><b>Please Choose State</b></div>');
...

										{
											...
											setTimeout(function(){
												...
												$("#msg").html('<div class="alert alert-warning" role="alert"><b>Please Choose City</b></div>');
...
function advertisement()
	...
	if(work!="" && worker!="" && payroll!="" && days!="")
       	{

							$('#msg3').hide();

							$("#msg3").html('<div class="alert alert-warning" role="alert"><i class="fas fa-spinner fa-spin"></i><b>Request in process Please Wait.... </b></div>');

							$('#msg3').show();

							$.post(myurl+"fetch/advertisment.php", {"work":work,"worker":worker,"payroll":payroll,"days":days},
											...
											if(data=="sent")

												{
													...
													setTimeout(function(){
														...
														$("#msg3").html('<div class="alert alert-success" role="alert"><b>Your Advertisment request sent. And It will be aprroved shortly</br></b></div>');
					...
					if(work=="")

						{
							...
							setTimeout(function(){
								...
								$("#msg3").html('<div class="alert alert-warning" role="alert"><b>Please Enter Work</b></div>');

								$('#msg3').show();

								$('#msg3').delay(2000).hide(1000); 
...

							{
								...
								setTimeout(function(){
									...
									$("#msg3").html('<div class="alert alert-warning" role="alert"><b>Please Enter Worker</b></div>');
...

								{
									...
									setTimeout(function(){
										...
										$("#msg3").html('<div class="alert alert-warning" role="alert"><b>Please Enter Payroll/Worker</b></div>');
	                                 ...
	                                 if(days=="")

	                                       {
			                                 ...
			                                 $("#msg3").html('<div class="alert alert-warning" role="alert"><b>Please Enter Days of Work</b></div>');
...

				{
...

					{
...

						{
							...
							$.post(myurl+"fetch/register.php", {"firstname":firstname,"lastname":lastname,"tel":tel,"cntry":cntry,"city":city,"address":address,"email":email,"pwd":pwd,"captcha":captcha},
...

											{
...

												{
													...
													setTimeout(function(){
														...
														$("#msg").html('<div class="alert alert-success" role="alert"><b>Your registration request sent Admin will aprrove it within an hour and inform you once approved then you will have the aacess of your dashboard</br></b></div>');
...

	{
		...
		setTimeout(function(){
			...
			$("#msg").html('<div class="alert alert-warning" role="alert"><b>Please Choose State Name</b></div>');
...
$.preloader.start({
	...
	if(firstname!="" && lastname!="" && tel!="" && city!="" && address!="" && email!="" && cntry!="")

	{
...

		{
			...
			{	
				...
				$.post(myurl+"fetch/update.php", {"firstname":firstname,"lastname":lastname,"tel":tel,"cntry":cntry,"city":city,"address":address,"email":email},
		...
		$.post(myurl+"fetch/submit.php", 
...

			{
...

				{
					...
					$("#msg").html('<div class="alert alert-warning" role="alert"><b>Your Request is Sent</b></div>');
...
function getappy()

		{
			//console.log(sakshi);
			 ...
			 var adby= document.getElementById('adby').value;
			...
			var address = document.getElementById('address').value;
				...
				if(captcha!="" && firstname!="" && lastname!="" && tel!="" && city!="" && address!=""  )

				{
					...
					else
					{
							...
							$.post(myurl+"fetch/register-bak.php", {"firstname":firstname,"lastname":lastname,"tel":tel,"cntry":cntry,"city":city,"address":address,"captcha":captcha,"adnum":adnum,"adby":adby},
											...
											location.reload(); 
...

												{
													...
													setTimeout(function(){
														...
														$("#msg").html('<div class="alert alert-success" role="alert"><b>Your  request sent to Admin will Share it With Farmer Within an hour</br></b></div>');
